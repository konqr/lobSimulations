...
def extract_stylized_facts():
    ...
    sparses = []
    #fig, ax = plt.subplots()
    pattern = r'^smalltickhawkes_.*_0\.5$'

    for fname in fnames:
        if bool(re.match(pattern, fname)):
            print(fname)
            ...
            shapes.append(shape)
    pickle.dump((labels,shapes), open(path+'shapes_eta_0.5','wb'))
    dict_res = {}
...
def sim_stylizedfacts_plot_reg():
    a,b,n,s_bar, eps, eps2, r_mid, D, shapemax, sparses = [0.044, 0.135, 0.235, 0.275, 1.41, 3.267, 3.741], [0.46, 0.59, 0.59, 0.35, 0.41, 0.5, 0.46], [], [np.float64(1.4946416673841836), np.float64(2.5827468170007757), np.float64(3.9736406844114827), np.float64(2.576315273209834), np.float64(12.179036700089679), np.float64(42.53693744115057), np.float64(41.62522627449745)] ,[np.float64(1.3375726894733706), np.float64(0.978194397622869), np.float64(0.6304670389101796), np.float64(0.8798803237663627), np.float64(0.26637276136130117), np.float64(0.09178401964074128), np.float64(0.10349461669498011)], [], [], [np.float64(0.9325839268876825), np.float64(1.8281875795485365), np.float64(2.5368672895155164), np.float64(2.2861828107961717), np.float64(10.942435508851306), np.float64(34.59271551013518), np.float64(51.85190461315714)] , [np.float64(0.01), np.float64(0.01), np.float64(0.12), np.float64(0.01), np.float64(0.25), np.float64(0.46), np.float64(0.4)] , []
    x_data = np.log(np.array(eps))/np.log(10)
    y_data = np.log(np.array(shapemax))/np.log(10)
    ...
    plt.ylabel('argmax $\\bar{q}(x)$ (log)', fontsize=14)
    plt.title('Simulation Study: argmax $\\bar{q}(x)$ (\$) vs $\epsilon$ (in bps)')
    plt.xlim(xlim)
...
def sim_wass():
    ...
    # eps = [np.float64(1.7504907992908174), np.float64(1.7149403548546973), np.float64(1.3539124932770736), np.float64(0.7661018636540287), np.float64(0.5558394344035898), np.float64(0.7892855108732292), np.float64(0.8248997101302495), np.float64(0.6641577804703038), np.float64(0.32108513892629487), np.float64(0.3058559475642696), np.float64(0.1806859033508877), np.float64(0.3300476243644297), np.float64(0.4591216290118335)]
    a,b,n,s_bar, eps, eps2, r_mid, D, shapemax, sparses = [0.044, 0.135, 0.235, 0.275, 1.41, 3.267, 3.741], [0.46, 0.59, 0.59, 0.35, 0.41, 0.5, 0.46], [], [np.float64(1.4946416673841836), np.float64(2.5827468170007757), np.float64(3.9736406844114827), np.float64(2.576315273209834), np.float64(12.179036700089679), np.float64(42.53693744115057), np.float64(41.62522627449745)] ,[np.float64(1.3375726894733706), np.float64(0.878194397622869), np.float64(0.6304670389101796), np.float64(0.8798803237663627), np.float64(0.26637276136130117), np.float64(0.10178401964074128), np.float64(0.10349461669498011)], [], [], [np.float64(0.9325839268876825), np.float64(1.8281875795485365), np.float64(2.5368672895155164), np.float64(2.2861828107961717), np.float64(10.942435508851306), np.float64(34.59271551013518), np.float64(51.85190461315714)] , [np.float64(0.01), np.float64(0.01), np.float64(0.12), np.float64(0.01), np.float64(0.25), np.float64(0.46), np.float64(0.4)] , []

    plt.errorbar(eps, [s[0] for s in sparses], yerr=[np.sqrt(s[1])/2 for s in sparses], marker='o', markersize=8, linestyle='none', capsize=5, color = 'lightcoral', label = 'Simulated Small/Medium Tick LOBs')
...
# print(a,b,eps,s_bar)
a,b = [0.044, 0.135, 0.235, 0.275, 1.41, 3.267, 3.741], [0.46, 0.59, 0.59, 0.35, 0.41, 0.5, 0.46]
eps = [np.float64(1.3375726894733706), np.float64(0.878194397622869), np.float64(0.6304670389101796), np.float64(0.8798803237663627), np.float64(0.26637276136130117), np.float64(0.10178401964074128), np.float64(0.10349461669498011)]
labels, shapes = pickle.load(open(f'D:\\PhD\\results - small tick\\sim\\smalltick_is\\shapes_eta_0.5','rb'))
# for alpha, beta, e, s in zip(a,b,eps,s_bar):
#     try:
#         shapes = pickle.load(open(f'D:\\PhD\\results - small tick\\sim\\smalltick_is\\shapes_eta_0.5','rb'))
...
i = 0
for e, s in zip(eps, shapes):
    d = s[0]
    v = s[1]
    plt.plot(d[v>1e-4],v[v>1e-4], label = f'$\\alpha$ : {a[i]:.2f},$\\beta$ : {b[i]:.2f}',color=colors[i], marker='o', markevery=10)
    i+=1
plt.yscale("log")
plt.xscale("log")
