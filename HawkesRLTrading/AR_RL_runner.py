...
np.save(log_dir + "without_twap_5.npy", np.array(inventory_without_twap))

if(twap_side == "sell"):
    np.save(log_dir + "with_twap_5_sell.npy", np.array(inventory_with_twap_sell))
else:
    np.save(log_dir + "with_twap_5_buy.npy", np.array(inventory_with_twap_buy))
