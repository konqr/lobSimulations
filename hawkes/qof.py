...
def runACF(paths, resultsPath, sDate, eDate, ric):
    ...
    plt.scatter(statsmodels.tsa.stattools.acf(empRets, nlags = 10000), label = "Empirical")
    plt.scatter(statsmodels.tsa.stattools.acf(simRets, nlags = 10000), label = "Simulated")
    # plt.yscale("log")
    plt.legend()
