...
def simulate(T , paramsPath , todPath, s0 = None, filePathName = None, Pis = None, Pi_Q0 = None, beta = 0.7479, avgSpread = 0.0169, spread0 = 3, price0 = 260):
    ...
    lamb = None
    while s <= T:
        s, n, timestamps_this, tau, lamb = thinningOgataIS2(T, paramsPath, todPath, maxJumps = 1, s = s, n = n, Ts = timestamps, spread=spread, beta = beta, avgSpread = avgSpread, lamb = lamb)
        sizes = {}
        dictTimestamps = {}
